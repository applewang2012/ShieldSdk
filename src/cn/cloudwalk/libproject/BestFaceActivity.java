...
public class BestFaceActivity extends TemplatedActivity implements FaceInfoCallback {
    ...
    final static int BESTFACE = 101, SET_RESULT = 122, FACE_TIMEOUT = 123, PLAYMAIN_END = 125, CLEARFACE = 126;
    boolean isStop;// 界面遮盖
    ...
    public void onRightClick(View v) {
        ...
        reset();
        mMainHandler.sendEmptyMessageDelayed(CLEARFACE, 800);
...
//                            .setMessage("您禁止了访问存储的权限，请在手机设置中开启权限！")
